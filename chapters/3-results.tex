...
are AUC values with confidence intervals included.
...
types except for T₂w where AUC dropped to 0.68. DWI derived parametric maps
(ADCₘ, ADCₖ, K) had AUC between 0.69 to 0.73, and T₂ derived features had
AUC=0.70.
