...
\textbf\newline{Machine learning of prostate MRI: towards improved non-invasive
prostate cancer characterization}
}
\newline
% Insert author names, affiliations and corresponding author email (do not
% include titles, positions, or degrees).
% % \author[dia,inf]{Jussi~Toivonen\corref{cor1}}
...
\\
%Jussi Toivonen\textsuperscript{1,2*\textcurrency},
...
% % \address[rad]{Department of Radiology, University of Massachusetts---Baystate, Springfield, MA, USA}
...
\textbf{7} Dept. of Radiology, University of Massachusetts---Baystate, Springfield, MA, USA\\
\bigskip
...
% \include{chapters/6-tables}
% \include{chapters/7-figures}
